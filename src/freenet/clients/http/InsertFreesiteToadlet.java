...
public class InsertFreesiteToadlet extends Toadlet {
	...
	public void handleMethodGET(URI uri, HTTPRequest req, ToadletContext ctx) throws ToadletContextClosedException, IOException {
		...
		contentBox.addChild(new BlockText(l10n("content1")));
		
		NodeL10n.getBase().addL10nSubstitution(contentBox.addChild(new BlockText()), "InsertFreesiteToadlet.contentFlogHelper", new String[] { "plugins" }, new HTMLNode[] { HTMLNode.link(PproxyToadlet.PATH) });
		
		NodeL10n.getBase().addL10nSubstitution(contentBox.addChild(new BlockText()), "InsertFreesiteToadlet.content2",
		...
		contentBox.addChild(new BlockText(l10n("content3")));
		...
		NodeL10n.getBase().addL10nSubstitution(contentBox.addChild(new BlockText()), "InsertFreesiteToadlet.contentThingamablog",
