...
public class InvalidAddressOverrideUserAlert extends AbstractUserAlert {
	...
	public HTMLNode getHTMLText() {
		...
		itemNode.addInlineBox(Category.CONFIGSHORTDESC, NodeL10n.getBase().getString(o.getShortDesc())).addChild("input", new String[] { "type", "name", "value" }, new String[] { "text", sc.getPrefix() + ".ipAddressOverride", o.getValueString() });
